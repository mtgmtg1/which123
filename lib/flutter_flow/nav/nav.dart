          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => ProPageWidget(
                filterBasic: params.getParam('filterBasic', ParamType.String),
                filterRecent: params.getParam('filterRecent', ParamType.String),
                filterBest: params.getParam('filterBest', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'authpage',
            ...
            FFRoute(
              name: 'Company1',
              path: 'company1',
              builder: (context, params) => Company1Widget(),
            ),
            FFRoute(
              name: 'Company2',
              path: 'company2',
              builder: (context, params) => Company2Widget(),
            ),
            FFRoute(
              name: 'Company3',
              path: 'company3',
              builder: (context, params) => Company3Widget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'wellbeinginfo',
              path: 'wellbeinginfo',
              builder: (context, params) => WellbeinginfoWidget(),
            ),
            FFRoute(
              name: 'forgotpassword',
              path: 'forgotpassword',
            ...
            FFRoute(
              name: 'proenroll',
              path: 'proenroll',
              builder: (context, params) => ProenrollWidget(),
            ),
            FFRoute(
              name: 'profileview',
              path: 'profileview',
