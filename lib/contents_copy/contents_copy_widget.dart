...
class ContentsCopyWidget extends StatefulWidget {
  const ContentsCopyWidget({Key? key}) : super(key: key);

  @override
  _ContentsCopyWidgetState createState() => _ContentsCopyWidgetState();
}

class _ContentsCopyWidgetState extends State<ContentsCopyWidget> {
