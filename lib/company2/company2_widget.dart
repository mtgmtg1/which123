...
class _Company2WidgetState extends State<Company2Widget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CompanyRecord>>(
      future: queryCompanyRecordOnce(),
                        ...
                        builder: (context, snapshot) {
                          ...
                          return SingleChildScrollView(
                            child: Column(
                              ...
                              children:
                                  List.generate(columnCompanyRecordList.length,
                                      (columnIndex) {
                      ...
                      child: Visibility(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(50, 0, 0, 80),
                              child: Container(
